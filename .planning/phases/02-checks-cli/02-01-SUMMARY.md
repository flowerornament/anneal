...
3. **Task 3: Remove dead_code allows and validate Large Corpus corpus** - `b144c59` (feat)
...
- `src/main.rs` - Wired terminal_by_directory from build_graph into infer_lattice; expanded Large Corpus corpus test assertions
