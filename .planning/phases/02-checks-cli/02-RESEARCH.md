...
From the Large Corpus corpus analysis:
...
**Why it happens:** Large Corpus has ~870 bare file refs. Some filenames may exist in multiple subdirectories.
...
- **Test corpus:** `/path/to/large-corpus/.design/` (260 files, 120 with frontmatter)
...
- Large Corpus corpus analysis (grep-based): status distributions, directory conventions, frontmatter field usage.
...
- Pitfalls: HIGH -- derived from Phase 1 observations and Large Corpus corpus analysis with concrete numbers
