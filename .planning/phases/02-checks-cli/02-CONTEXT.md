...
### Test Corpus
- `/path/to/large-corpus/.design/` — Primary test corpus (260 files, 120 with frontmatter, 15+ frontmatter field types, 25 status values). Integration tests point here by path.
