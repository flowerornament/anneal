...
- Check exits non-zero when errors exist (1092 errors on Large Corpus corpus)
...
3. **Task 3: Human verification against Large Corpus corpus** - awaiting checkpoint
...
## Large Corpus Corpus Verification Results

All commands tested against `/path/to/large-corpus/.design/` (260 files):
...
| `anneal impact sample-formal-model-v16` | Working | Shows v17 as directly affected |
