...
**All 334 Large Corpus diagnostics now carry non-null file and line -- zero null fields in --json output**
...
- **Found during:** Task 2 (verification on Large Corpus corpus)
