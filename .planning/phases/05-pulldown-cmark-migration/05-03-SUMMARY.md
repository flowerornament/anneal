...
**pulldown-cmark scanner replaces regex scanner in build_graph; parallel-run tests confirm 13-18% fewer false positives on Large Corpus and Host Corpus corpora with 100% SourceSpan coverage**
...
- Parallel-run comparison tests document quality improvement: Large Corpus 9734->8441 refs (13% fewer), Host Corpus 1039->852 refs (18% fewer)
- 100% SourceSpan coverage on body DiscoveredRefs across both corpora (8441/8441 Large Corpus, 852/852 Host Corpus)
...
- `src/parse.rs` - Replaced scan_file with scan_file_cmark in build_graph; added parallel_run_large-corpus and parallel_run_host-corpus tests
