...
| F08 | check                | default on large-corpus            | 16 suggestions back-to-back, no visual grouping between severity classes                         | nit      | —    | Insert a blank line between severity groups (errors → info → suggestions)                   | open   |
...
| F16 | find                 | kw (large-corpus)                  | File column repeats same base path 18× when all hits are sections of one file                    | design   | —    | Out of scope (needs grouping); note for Round 3                                             | open   |
