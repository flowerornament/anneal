...
148-predicate long tail of uneven evidence. These are **symptoms of unclean
...
| **topic** | same subject? | shared file/label citation targets over hub-excluded `Cites` pairs | REPORT (never asserted edge) | the clustering keystone |
...
pass*: the 148 derived predicates have uneven evidence, and we don't currently
...
Assigning all 192 relations (12 stored · 32 primitive · 148 derived) against the
...
| **topic** | pairwise file/label citation-target siblings; `area*` stays on structure |
