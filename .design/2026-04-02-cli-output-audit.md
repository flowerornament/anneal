...
- Self corpus: `/path/to/anneal/.design`
- Host Corpus corpus: `/path/to/host-corpus/.design`
- Large Corpus corpus: `/path/to/large-corpus/.design`
...
- `print_json()` pretty-prints all JSON output via `serde_json::to_string_pretty(...)` in [src/cli.rs](/path/to/anneal/src/cli.rs#L94).
- `CheckOutput` always includes `extractions`, and JSON mode clones `result.extractions` before formatting in [src/cli.rs](/path/to/anneal/src/cli.rs#L106) and [src/main.rs](/path/to/anneal/src/main.rs#L684).
- `MapOutput` serializes a full rendered graph as a `content: String` field in [src/cli.rs](/path/to/anneal/src/cli.rs#L1233).
- Human `get` output caps edge display with `EDGE_DISPLAY_LIMIT`, but JSON `get` returns the full edge lists in [src/cli.rs](/path/to/anneal/src/cli.rs#L262).
- `find` performs unrestricted substring matching across all handles and returns all matches in [src/cli.rs](/path/to/anneal/src/cli.rs#L486).
...
| `anneal --root /path/to/host-corpus/.design status` | Host Corpus | `0` | `11` | `368` |
| `anneal --root /path/to/host-corpus/.design status --json` | Host Corpus | `0` | `93` | `1,525` |
| `anneal --root /path/to/host-corpus/.design status --verbose` | Host Corpus | `0` | `60` | `3,170` |
| `anneal --root /path/to/large-corpus/.design status` | Large Corpus | `0` | `11` | `374` |
| `anneal --root /path/to/large-corpus/.design status --json` | Large Corpus | `0` | `104` | `1,762` |
| `anneal --root /path/to/large-corpus/.design status --verbose` | Large Corpus | `0` | `21` | `842` |
...
| `anneal --root /path/to/host-corpus/.design check` | Host Corpus | `1` | `74` | `7,507` |
| `anneal --root /path/to/host-corpus/.design check --json` | Host Corpus | `1` | `16,056` | `393,204` |
| `anneal --root /path/to/host-corpus/.design check --file=README.md --json` | Host Corpus | `0` | `15,619` | `376,500` |
| `anneal --root /path/to/host-corpus/.design check --include-terminal` | Host Corpus | `1` | `202` | `16,875` |
| `anneal --root /path/to/large-corpus/.design check` | Large Corpus | `0` | `6` | `333` |
| `anneal --root /path/to/large-corpus/.design check --json` | Large Corpus | `0` | `129,645` | `3,072,828` |
| `anneal --root /path/to/large-corpus/.design check --include-terminal` | Large Corpus | `1` | `408` | `35,470` |
...
- `CheckOutput` always includes `extractions` in JSON-facing data structures in [src/cli.rs](/path/to/anneal/src/cli.rs#L106).
- `main.rs` unconditionally clones `result.extractions` whenever `cli_args.json` is true in [src/main.rs](/path/to/anneal/src/main.rs#L684).
...
| `anneal --root /path/to/host-corpus/.design get README.md` | Host Corpus | `0` | `4` | `148` |
| `anneal --root /path/to/host-corpus/.design get README.md --json` | Host Corpus | `0` | `9` | `236` |
| `anneal --root /path/to/large-corpus/.design get LABELS.md` | Large Corpus | `0` | `28` | `676` |
| `anneal --root /path/to/large-corpus/.design get LABELS.md --json` | Large Corpus | `0` | `3,216` | `59,140` |
| `anneal --root /path/to/large-corpus/.design get OPEN-QUESTIONS.md` | Large Corpus | `0` | `29` | `816` |
| `anneal --root /path/to/large-corpus/.design get OPEN-QUESTIONS.md --json` | Large Corpus | `0` | `796` | `14,643` |
...
- Human mode caps displayed incoming and outgoing edges with `EDGE_DISPLAY_LIMIT` in [src/cli.rs](/path/to/anneal/src/cli.rs#L262).
...
| `anneal --root /path/to/host-corpus/.design find OQ` | Host Corpus | `0` | `13` | `749` |
| `anneal --root /path/to/host-corpus/.design find OQ --namespace=OQ --json` | Host Corpus | `0` | `66` | `1,335` |
| `anneal --root /path/to/host-corpus/.design find ""` | Host Corpus | `0` | `3,270` | `415,787` |
| `anneal --root /path/to/host-corpus/.design find "" --json` | Host Corpus | `0` | `19,620` | `670,286` |
| `anneal --root /path/to/large-corpus/.design find ""` | Large Corpus | `0` | `10,084` | `1,290,850` |
| `anneal --root /path/to/large-corpus/.design find "" --json` | Large Corpus | `0` | `60,504` | `2,077,129` |
| `anneal --root /path/to/large-corpus/.design find "" --status=living --json` | Large Corpus | `0` | `30` | `583` |
| `anneal --root /path/to/large-corpus/.design find "" --kind=label --json` | Large Corpus | `0` | `3,000` | `64,895` |
...
- `cmd_find()` performs unrestricted case-insensitive substring matching and returns all matches in [src/cli.rs](/path/to/anneal/src/cli.rs#L486).
...
| `anneal --root /path/to/host-corpus/.design init --dry-run` | Host Corpus | `0` | `97` | `1,379` |
| `anneal --root /path/to/host-corpus/.design init --dry-run --json` | Host Corpus | `0` | `106` | `2,084` |
| `anneal --root /path/to/large-corpus/.design init --dry-run` | Large Corpus | `0` | `131` | `1,882` |
| `anneal --root /path/to/large-corpus/.design init --dry-run --json` | Large Corpus | `0` | `140` | `2,741` |
...
| `anneal --root /path/to/host-corpus/.design impact README.md` | Host Corpus | `0` | `4` | `97` |
| `anneal --root /path/to/host-corpus/.design impact README.md --json` | Host Corpus | `0` | `5` | `62` |
| `anneal --root /path/to/large-corpus/.design impact LABELS.md` | Large Corpus | `0` | `4` | `140` |
| `anneal --root /path/to/large-corpus/.design impact LABELS.md --json` | Large Corpus | `0` | `7` | `121` |
...
- `ImpactOutput` serializes the full `direct` and `indirect` vectors in [src/cli.rs](/path/to/anneal/src/cli.rs#L560).
...
| `anneal --root /path/to/host-corpus/.design map` | Host Corpus | `0` | `3,394` | `245,305` |
| `anneal --root /path/to/host-corpus/.design map --json` | Host Corpus | `0` | `6` | `248,812` |
| `anneal --root /path/to/large-corpus/.design map` | Large Corpus | `0` | `10,269` | `749,196` |
| `anneal --root /path/to/large-corpus/.design map --json` | Large Corpus | `0` | `6` | `759,858` |
| `anneal --root /path/to/large-corpus/.design map --around=LABELS.md --depth=1` | Large Corpus | `0` | `493` | `6,339` |
| `anneal --root /path/to/large-corpus/.design map --around=LABELS.md --depth=2` | Large Corpus | `0` | `616` | `13,438` |
| `anneal --root /path/to/large-corpus/.design map --around=LABELS.md --depth=2 --json` | Large Corpus | `0` | `6` | `14,127` |
...
- `MapOutput` includes `content: String` in [src/cli.rs](/path/to/anneal/src/cli.rs#L1233).
- Neighborhood extraction expands with BFS depth in [src/cli.rs](/path/to/anneal/src/cli.rs#L1252).
...
| `anneal --root /path/to/host-corpus/.design diff` | Host Corpus | `0` | `4` | `126` |
| `anneal --root /path/to/host-corpus/.design diff --json` | Host Corpus | `0` | `19` | `345` |
| `anneal --root /path/to/large-corpus/.design diff` | Large Corpus | `0` | `4` | `126` |
| `anneal --root /path/to/large-corpus/.design diff --json` | Large Corpus | `0` | `19` | `345` |
...
| `anneal --root /path/to/host-corpus/.design obligations` | Host Corpus | `0` | `1` | `51` |
| `anneal --root /path/to/host-corpus/.design obligations --json` | Host Corpus | `0` | `6` | `95` |
| `anneal --root /path/to/large-corpus/.design obligations` | Large Corpus | `0` | `1` | `51` |
| `anneal --root /path/to/large-corpus/.design obligations --json` | Large Corpus | `0` | `6` | `95` |
