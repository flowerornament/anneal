...
The default text output lists diagnostics in code order. In Large Corpus, 13 S002 suggestions appear before the 2 E001 errors. Human output should sort by severity (errors first, then warnings, then info, then suggestions) regardless of code number.
