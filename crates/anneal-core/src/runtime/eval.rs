...
use primitive_index::{PrimitiveIndex, PrimitiveIndexContext};
...
pub struct Database {
    ...
    primitive_index: Arc<PrimitiveIndex>,
...
impl Default for Database {
    fn default() -> Self {
        let tuples = Arc::new(TupleDb::default());
        let primitive_index = Arc::new(PrimitiveIndex::from_tuples(&tuples));
        Self {
            tuples,
...
impl Database {
    ...
    fn from_store_with_visibility(
        ...
        let primitive_index = PrimitiveIndex::from_tuples(&tuples);
        ...
        Self {
            ...
            primitive_index: Arc::new(primitive_index),
    ...
    pub fn with_evaluation_day(mut self, day: i64) -> Self {
        Arc::make_mut(&mut self.primitive_index)
            .apply_context(PrimitiveIndexContext::EvaluationDay(day));
        self
    }
    ...
    pub(crate) fn derived_relation(&self, predicate: &PredicateRef) -> Option<&DerivedRelation> {
    ...
    pub(crate) fn primitive_tuples(
        ...
        primitive_tuples(primitive, constraints, self, options, regex_cache)
    }
    ...
    pub(crate) fn physical_tuple_store(
        &self,
        relation: &Ident,
    ...
    pub(crate) fn stored_tuple_derivation(
        &self,
        relation: &Ident,
        row: RowId,
    ...
    pub(crate) fn stored_tuple_row_visible(
        &self,
        relation: &Ident,
        row: RowId,
        options: &EvalOptions,
    ...
    pub(crate) fn scoped_to_time_ref(
        &self,
        reference: &str,
    ) -> Result<(Self, Vec<QueryWarning>), EvalError> {
    ...
    fn time_scope_overlay(&self, selection: &SnapshotSelection) -> Self {
        ...
        scoped.primitive_index = Arc::new(
    ...
    fn clone_shell_for_time_scope(&self) -> Self {
        Self {
            ...
            derived: BTreeMap::new(),
            primitive_index: Arc::clone(&self.primitive_index),
