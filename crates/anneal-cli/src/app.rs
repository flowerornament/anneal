...
use anneal_core::{
    ...
    ConfigFacts, CorpusId, FactStore, Generation, InferredCorpusRoot, ProjectExtension,
...
use navigation::{handle_impact_rows, handle_lineage_rows};
...
mod tests {
    ...
    use anneal_core::{
        EdgeFact, FactBatch, FactBatchMode, FactIdentity, HandleFact, MetaFact, NativeId,
        OriginUri, Revision, SourceName,
    };
    use std::fs;
