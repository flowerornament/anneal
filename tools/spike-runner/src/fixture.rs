...
pub mod ids {
    ...
    pub const SNAPSHOT_LAST: crate::types::SnapshotId = crate::types::SnapshotId("snapshot:last");
}

use ids::{
    COMPILER, DISCHARGE_NOTE, EXEC, FORMAL, JIT_SPEC, JIT_STALE, NS_OQ, OQ_22, OQ_23, OQ_60, OQ_77,
    OQ_88, OQ_99, RESEARCH, RESEARCH_LOG, SNAPSHOT_LAST, SYNTHESIS, V14, V15, V16, V17,
};
...
pub const HANDLES: &[Handle] = &[
    ...
    Handle {
        ...
        file: FilePath("formal-model/v17.md"),
        area: FORMAL,
        date: Some("2026-03-25"),
    },
    Handle {
        id: V16,
        kind: HandleKind::File,
        ...
        namespace: Namespace::NONE,
        file: FilePath("formal-model/v16.md"),
        area: FORMAL,
    ...
    Handle {
        ...
        status: Status::Superseded,
        namespace: Namespace::NONE,
        file: FilePath("formal-model/v15.md"),
        area: FORMAL,
        date: Some("2026-02-15"),
    },
    Handle {
        id: V14,
        kind: HandleKind::File,
        status: Status::Superseded,
        namespace: Namespace::NONE,
        file: FilePath("formal-model/v14.md"),
        area: FORMAL,
    ...
    Handle {
        ...
        status: Status::Superseded,
        namespace: Namespace::NONE,
        file: FilePath("compiler/jit-stale.md"),
        area: COMPILER,
        date: Some("2026-02-20"),
    },
    Handle {
        id: EXEC,
        kind: HandleKind::File,
        ...
        namespace: Namespace::NONE,
        file: FilePath("compiler/exec.md"),
        area: COMPILER,
    ...
    Handle {
        ...
        namespace: Namespace::NONE,
        file: FilePath("research-log/2026-04-jit.md"),
        area: RESEARCH_LOG,
        date: Some("2026-04-29"),
    },
    ...
    Handle {
        ...
        status: Status::Current,
        namespace: Namespace::NONE,
        file: FilePath("synthesis/2026-04-discharge.md"),
        area: SYNTHESIS,
        date: Some("2026-04-15"),
    },
...
pub const PENDING_EDGES: &[PendingEdge] = &[PendingEdge {
    from: JIT_SPEC,
...
mod tests {
    ...
    fn pending_edge_targets_are_genuinely_missing() {
        ...
        for p in PENDING_EDGES {
            assert!(
                !ids.contains(&p.target),
                "pending edge target {:?} actually exists — would not fire E001",
                p.target
            );
        }
    }
    ...
    fn fixture_exercises_required_capabilities() {
        ...
        assert!(
            HANDLES
                .iter()
                .any(|h| h.kind == HandleKind::Label && h.namespace == NS_OQ)
        );
